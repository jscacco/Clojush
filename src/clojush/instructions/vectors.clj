...
(define-registered exec_map_helper_integer_to_integer (with-meta (map_driver "integer" "integer") {:stack-types [:exec :hof_result :vector_integer] :parentheses 1}))
(define-registered exec_map_helper_integer_to_float (with-meta (map_driver "integer" "float") {:stack-types [:exec :hof_result :vector_integer :vector_float] :parentheses 1}))
(define-registered exec_map_helper_integer_to_boolean (with-meta (map_driver "integer" "boolean") {:stack-types [:exec :hof_result :vector_integer :vector_boolean] :parentheses 1}))
(define-registered exec_map_helper_integer_to_string (with-meta (map_driver "integer" "string") {:stack-types [:exec :hof_result :vector_integer :vector_string] :parentheses 1}))
(define-registered exec_map_helper_integer_to_char (with-meta (map_driver "integer" "char") {:stack-types [:exec :hof_result :vector_integer :string] :parentheses 1}))

(define-registered exec_map_helper_float_to_integer (with-meta (map_driver "float" "integer") {:stack-types [:exec :hof_result :vector_float :vector_integer] :parentheses 1}))
(define-registered exec_map_helper_float_to_float (with-meta (map_driver  "float" "float") {:stack-types [:exec :hof_result :vector_float] :parentheses 1}))
(define-registered exec_map_helper_float_to_boolean (with-meta (map_driver "float" "boolean") {:stack-types [:exec :hof_result :vector_float :vector_boolean] :parentheses 1}))
(define-registered exec_map_helper_float_to_string (with-meta (map_driver "float" "string") {:stack-types [:exec :hof_result :vector_float :vector_string] :parentheses 1}))
(define-registered exec_map_helper_float_to_char (with-meta (map_driver "float" "char") {:stack-types [:exec :hof_result :vector_float :string] :parentheses 1}))

(define-registered exec_map_helper_boolean_to_integer (with-meta (map_driver "boolean" "integer") {:stack-types [:exec :hof_result :vector_boolean :vector_integer] :parentheses 1}))
(define-registered exec_map_helper_boolean_to_float (with-meta (map_driver  "boolean" "float") {:stack-types [:exec :hof_result :vector_boolean :vector_float] :parentheses 1}))
(define-registered exec_map_helper_boolean_to_boolean (with-meta (map_driver "boolean" "boolean") {:stack-types [:exec :hof_result :vector_boolean] :parentheses 1}))
(define-registered exec_map_helper_boolean_to_string (with-meta (map_driver "boolean" "string") {:stack-types [:exec :hof_result :vector_boolean :vector_string] :parentheses 1}))
(define-registered exec_map_helper_boolean_to_char (with-meta (map_driver "boolean" "char") {:stack-types [:exec :hof_result :vector_boolean :string] :parentheses 1}))

(define-registered exec_map_helper_string_to_integer (with-meta (map_driver "string" "integer") {:stack-types [:exec :hof_result :vector_string :vector_integer] :parentheses 1}))
(define-registered exec_map_helper_string_to_float (with-meta (map_driver  "string" "float") {:stack-types [:exec :hof_result :vector_string :vector_float] :parentheses 1}))
(define-registered exec_map_helper_string_to_boolean (with-meta (map_driver "string" "boolean") {:stack-types [:exec :hof_result :vector_string :vector_boolean] :parentheses 1}))
(define-registered exec_map_helper_string_to_string (with-meta (map_driver "string" "string") {:stack-types [:exec :hof_result :vector_string] :parentheses 1}))
(define-registered exec_map_helper_string_to_char (with-meta (map_driver "string" "char") {:stack-types [:exec :hof_result :vector_string :string] :parentheses 1}))

(define-registered exec_map_helper_char_to_integer (with-meta (map_driver "char" "integer") {:stack-types [:exec :hof_result :string :vector_integer] :parentheses 1}))
(define-registered exec_map_helper_char_to_float (with-meta (map_driver  "char" "float") {:stack-types [:exec :hof_result :string :vector_float] :parentheses 1}))
(define-registered exec_map_helper_char_to_boolean (with-meta (map_driver "char" "boolean") {:stack-types [:exec :hof_result :string :vector_boolean] :parentheses 1}))
(define-registered exec_map_helper_char_to_string (with-meta (map_driver "char" "string") {:stack-types [:exec :hof_result :string :vector_string] :parentheses 1}))
(define-registered exec_map_helper_char_to_char (with-meta (map_driver "char" "char") {:stack-types [:exec :hof_result :string] :parentheses 1}))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;; end helper, begin normal

(define-registered exec_map_integer (with-meta (mapper "integer" "integer") {:stack-types [:exec :vector_integer]}))
...
(define-registered exec_map_float (with-meta (mapper  "float" "float") {:stack-types [:exec :vector_float]}))
...
(define-registered exec_map_boolean (with-meta (mapper "boolean" "boolean") {:stack-types [:exec :vector_boolean]}))
...
(define-registered exec_map_string (with-meta (mapper "string" "string") {:stack-types [:exec :vector_string]}))
...
(define-registered exec_map_char (with-meta (mapper "char" "char") {:stack-types [:exec :string]}))
...
(define-registered exec_filter_helper_integer (with-meta (filter-helper "integer") {:stack-types [:exec :vector_integer :hof_result] :parentheses 1}))
(define-registered exec_filter_helper_float (with-meta (filter-helper "float") {:stack-types [:exec :vector_float :hof_result] :parentheses 1}))
(define-registered exec_filter_helper_boolean (with-meta (filter-helper "boolean") {:stack-types [:exec :vector_boolean :hof_result] :parentheses 1}))
(define-registered exec_filter_helper_string (with-meta (filter-helper "string") {:stack-types [:exec :vector_string :hof_result] :parentheses 1}))
(define-registered exec_filter_helper_char (with-meta (filter-helper "char") {:stack-types [:exec :string :hof_result] :parentheses 1}))
