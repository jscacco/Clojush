...
(define-registered index_pop (with-meta (popper :index) {:stack-types [:index]}))
...
(define-registered index_dup (with-meta (duper :index) {:stack-types [:index]}))
...
(define-registered index_dup_times (with-meta (dup_timeser :index) {:stack-types [:index :integer]}))
...
(define-registered index_dup_items (with-meta (dup_itemser :index) {:stack-types [:index :integer]}))
...
(define-registered index_swap (with-meta (swapper :index) {:stack-types [:index]}))
...
(define-registered index_rot (with-meta (rotter :index) {:stack-types [:index]}))
...
(define-registered index_flush (with-meta (flusher :index) {:stack-types [:index]}))
...
(define-registered index_eq (with-meta (eqer :index) {:stack-types [:index :boolean]}))
...
(define-registered index_empty (with-meta (emptyer :index) {:stack-types [:index :boolean]}))
